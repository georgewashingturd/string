...
p_b & = & K \\
\partial_t \left ( \frac{\partial L}{\partial_t b}\right ) - \frac{\partial L}{\partial b} & = & m = 0
\neea
%
...
\neea
%
Taking its Poisson bracket with the hamiltonian
%
\nbea
...
%
\nbea
H & = &  p_b \dot b - K\dot b + m b + \lambda_1(p_b - K) + \lambda_2 m
\neea
%
...
p_b & = & a \\
p_a & = & 0 \\
\partial_t \left ( \frac{\partial L}{\partial_t b}\right ) - \frac{\partial L}{\partial b} & = & \dot a + ma = 0 \\
\partial_t \left ( \frac{\partial L}{\partial_t a}\right ) - \frac{\partial L}{\partial a} & = & mb = 0
\neea
%
...
%
\nbea
L & = & \frac{1}{2}a \dot b - \frac{1}{2}\dot a b -m ab \\
p_b & = & \frac{1}{2} a \\
p_a & = & -\frac{1}{2} b \\
\partial_t \left ( \frac{\partial L}{\partial_t b}\right ) - \frac{\partial L}{\partial b} & = & \frac{1}{2} \dot a + ma = 0 \\
\partial_t \left ( \frac{\partial L}{\partial_t a}\right ) - \frac{\partial L}{\partial a} & = & -\frac{1}{2} \dot b + mb = 0
\neea
%
