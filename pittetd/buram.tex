...
This is $a \leftrightarrow \sqrt{n}b$
%
\nbea
...
%
\nbea
(ac - \sqrt{n}bd)(ac + \sqrt{n}bd) & = & a^2c^2 - nb^2d^2 \\
& = & c^2(a^2 + nb^2) - nb^2c^2  - nb^2d^2 \\
& = & c^2(a^2 + nb^2) - nb^2(c^2  + d^2) \\
\neea
%
...
\neea
%
here also $p$ divides the LHA and the last term in the RHS and therefore divides $(ac + nbd)$
