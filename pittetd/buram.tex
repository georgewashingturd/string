...
In a way this is not that surprising, even in $\mathbb{Z}$ to check if a number $n$ is a perfect square we sort of need to do roughly $\frac{n-1}{2}$ operations, this is because any perfect square is a sum of consecutive odd numbers
%
\nbea
n^2 = 1 + 3 + 5 + \dots
\neea
%
which is clearer if you draw them out in terms of boxes.
