...
\neea
%
we need to show that the sum must be convergent before summing it, but $e^{-x}$ might not be $< 1$, 
%
\nbea
e^{-x} & < & 1 \\
\to x & > & 0
\neea
%
so the problem child is when $x=0$, this is similar to the situation for
%
\nbea
