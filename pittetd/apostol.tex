...
{\bf Page 60}, ``It can be shown that $\xi(2) = \pi^2/6$'', an elementary proof of this fact is thorugh the Fourier series (not Fourier transform) of $x^2$
%
\nbea
...
\neea
%
where $\cos(\pm n\pi) = \cos(n\pi) = (-1)^n$, thus
%
\nbea
