...
d) Deduce from b), c) and the minimality of 1 among the positive integers that $\psi(2n + 1) \ge 2n \log 2$. Conclude from this that as $x \to \infty$ , we have $\psi(x) ≥ x(\log 2 + o(1))$, so that $\pi(x) ≥ (\log 2 + o(1))x/ \log x$.
