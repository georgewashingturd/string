...
%
\nbea
\frac{\pi(2x)/(2x/\log 2x)}{\pi(x)/(x/\log x)} \frac{2\log 2 + o(1)}{2 \log 2 + o(1)} \\
\frac{\pi(2x)\log 2x}{2 \pi(x)\log x} \frac{2\log 2 + o(1)}{2 \log 2 + o(1)} \\
\neea
%

%
\nbea
\frac{2x}{\log 2x} - \frac{x}{\log x} & = & \frac{2x\log x - x \log 2x}{\log 2x \log x} \\
& = & \frac{2x\log x - x\log x - x\log 2}{\log 2x \log x} \\
& = & \frac{x\log x - x\log 2}{\log 2x \log x} \\
& = & \frac{x - x\log 2/\log x}{\log 2x} \\
\neea
%
