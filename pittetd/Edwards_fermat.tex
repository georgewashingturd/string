...
\nbea
P^2 - AQ^2 & = & K, ~~~~~~~ K = \pm k \\
\to (P^2 \mp p^2) & = & A(Q^2 \pm q^2) 
\neea
%

this also means that $r^2 - A = \pm k^2$
...
& = & QP - {\rm sgn}(k)pq K \\
& = & (p + qr)(pr + qA) - {\rm sgn}(k)pq K \\
& = & p^2r + pqA + pqr^2 + q^2A - {\rm sgn}(k)pq K \\
\neea
%
...
\nbea
& = & p^2r + pqA + pqr^2 + q^2A \\
& = & p^2(r + R) - p^2R + pqA + pqr^2 + q^2A \\
& = & p^2(r + R) - p^2R + 2pqA + pq(r^2 - A) + q^2A \\
& = & p^2(r + R) + pq(r^2 - A) - p^2R  - p^2A +A( p + q)^2 \\
\neea
%
...
%
\nbea
pP + AqQ & = & \frac{pP|k| + Aq(p + qr)}{|k|} \\
& = & \frac{p(P|k| Aq) + Aq^2r}{|k|} \\
& = & \frac{p(P|k| Aq) + Aq^2(r+R) - Aq^2R}{|k|} \\
& = & \frac{Aqp(P|k| - qR) + Aq^2(r+R)}{|k|} \\
& = & \frac{Aqp((pr + qA)|k| - qR) + Aq^2(r+R)}{|k|} \\
\neea
%
