...
{\bf Proposition 93.1.0}, A reformulation of the above, {\it If a non-unit $h(\alpha) | p$ an odd prime and $p \equiv 1 \pmod{\lambda}$, then $h(\alpha)$ divides a binomial and is prime cyclotomic.}
