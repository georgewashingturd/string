...
\end{Verbatim}
%
The weakness of this script is I always assign $\eta_i$ to $\pm u_i$ there's no clyclic permutation I can add that in the future. For  $\lambda = 13$ and $p = 61$ the result is
%
\nbea
...
Using the Python script from Problem 3 we get
%
\nbea
