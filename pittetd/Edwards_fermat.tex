...
\neea
%
with $A + B = f - 1 + 1$ (again the plus one is from the main term) and it must be that $B = A + 1$ (as dictated by No. 3), therefore $A = a = \frac{f}{2} - 1$ and
%
\nbea
(\theta_0 - \theta_1)^2 & = & -4(a + 1) + 1 \\
& = & -2 f + 1 = -\lambda
...
\neea
%
to check the (difficult) numbers for $p = 7$, $735 = 7 \cdot 105, 1624 = 7 \cdot 232, 1764 = 7 \cdot 252, 720 = 7 \cdot 102 + 6$, for $p = 11$, $1320 = 11 \cdot 120, 18150 = 11 \cdot 1650, 157773 = 11\cdot 14343, 902055 = 11\cdot82005, 3416930 = 11\cdot310630, 8409500 = 11\cdot764500, 12753576 = 11\cdot1159416, 10628640 = 11\cdot966240, 3628800 = 11\cdot 329890 + 10$.

{\bf Page 114, Problem 3}. 
