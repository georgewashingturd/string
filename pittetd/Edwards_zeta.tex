...
Remarks on estination of error as the last term omitted, since the Bernoulli's numbers at some point will grow out of bounds, the decrease is only in the beginning , the estimate of the last term error by $\int_{10}^{10.5}$ is still valid, it's just that the whole thing is super big.{NOT DONE YET}
