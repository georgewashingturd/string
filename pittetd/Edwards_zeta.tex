...
I find it interesting that to prove that the limit of the sum is the sum of the limit we just need to show that the latter converges but we did not need to show that they converge to the same value.
...
%
\nbea
\int_0^x \log(t) d\psi(t) & = & \left. \log(t) \psi(t) \right|_0^x + \int_0^x t^{-2} \psi(t) dt \\
